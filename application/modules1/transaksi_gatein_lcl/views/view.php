...
<div class="page-header">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">..::: Gate In LCL :::..</li>
    </ol>
</div>
                        ...
                        <div class="col-xl-4 col-lglg-4 col-md-4 col-sm-12 col-12">
                            ...
                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                <div class="form-group row gutters">
                                    <label for="inputName" class="col-sm-5 col-form-label text-left">Date In Container</label>
                                    <div class="col-sm-7">
                    ...
                    <div class="row gutters" style="margin-top:1%">                        
                        <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                            <div class="table-container" style="width:100%"> 
                                ...
                                <div class="table-responsive" style="margin-top:-2%;padding: 1px 1px 70px 1px;">
                                    ...
                                    <div class="btn-group" style="margin-bottom:0.2%;">
                                        ...
                                        <div class="dropdown-menu" id="showaksi">          
                                            <a class="dropdown-item btnexport"><span class="icon-download"></span>&nbsp;Export Xls</a>
                                            <a class="dropdown-item btnimport"><span class="icon-control_point"></span>&nbsp;Add Import</a>
                                    ...
                                    <table id="tbl_gatein_lcl" class="table m-0 dataTable no-footer nowrap" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>No</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        tbl_gatein_lcl = $('#tbl_gatein_lcl').DataTable({
            "destroy"       : true,
            "processing"    : true, 
            "serverSide"    : true, 
            "order"         : [], 
            ...
            "pageLength": 25,
            "ajax": {
                "url": "<?php echo site_url('transaksi/gatein_lcl/tbl_gatein_lcl') ?>",
                "type": "POST",
                "beforeSend": function() {
                ...
                "complete": function() {
                        ...
                        //tbl_gatein_lcl.$('tr.selected').removeClass('selected');
                        //tbl_gatein_lcl.row(selectbaris).nodes().to$().toggleClass( 'selected' );
                        
                        //var data = tbl_gatein_lcl.row(selectbaris).data();
                        //id_beacukai = data[1];
                        REF_NUMBER = '' ;
                        sending = '' ;
                    }
        ...
        $('#tbl_gatein_lcl tbody').on('click', 'tr', function() {
            var data = tbl_gatein_lcl.row(this).data();
    ...
    function GetCheckRefNumber(){
        $("#tbl_gatein_lcl input[type=checkbox]:checked").each(function () {
    ...
    $(document).on('click', '.btnsinkron', function(e) {
        ...
        url = '<?php echo site_url('transaksi/gatein_lcl/sinkron_data') ?>';
    ...
    $(document).on('click', '.btnUnsinkron', function(e) {
        ...
        url = '<?php echo site_url('transaksi/gatein_lcl/unsinkron_data') ?>';
        data = {arrREF_NUMBER:arrREF_NUMBER};
    ...
    $(document).on('click', '.btnsend', function(e) {
        ...
        url = '<?php echo site_url('transaksi/gatein_lcl/formkirimdata') ?>';
    ...
    $(document).on('click', '.btnedit', function(e) {
        ...
        url = '<?php echo site_url('transaksi/gatein_lcl/formedit') ?>';
    ...
    $(document).on('click', '.btnrebuild', function(e) {
        ...
        if (jawab === true) { 
            url = '<?php echo site_url('transaksi/gatein_lcl/change_reff_number') ?>';
            data = {REF_NUMBER: REF_NUMBER};
    ...
    $(document).on('click', '.btndelete', function(e) {
        ...
        if (jawab === true) { 
            url = '<?php echo site_url('transaksi/gatein_lcl/delete_reff_number') ?>';
            data = {arrREF_NUMBER: arrREF_NUMBER};
    ...
    $(document).on('click', '.btnimport', function(e) {
        url = '<?php echo site_url('transaksi/gatein_lcl/import_gate_in_lcl') ?>';
        data = "" ;
        divform = "#div_popup_form" ;
    ...
    $(document).on('click', '.btnexport', function(e) {
        ...
        var NO_POS_BC11 = $('#NO_POS_BC11').val();
        var NO_CONT = $('#NO_CONT').val();
        var NO_DOK_INOUT = $('#NO_DOK_INOUT').val();
        var NO_BL_AWB = $('#NO_BL_AWB').val();
        var FLAG_WHS = $('#FLAG_WHS').val();
        ...
        var page = "<?php echo base_url(); ?>transaksi/gatein_lcl/exportxls?data="+btoa(data) ;
        window.open(page);
