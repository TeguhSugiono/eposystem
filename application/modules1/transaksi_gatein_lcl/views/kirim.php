    ...
    <div class="modal-dialog modal-xs boxshadow">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Send Gate In LCL <?=$proses;?></h5>
...
<script type="text/javascript">    
    ...
    $('#btnkirim').click(function() {
        ...
        url = '<?php echo site_url('transaksi/gatein_lcl/kirimdata') ?>';
        data = {
            arrREF_NUMBER: arrREF_NUMBER,
            proses:"<?=$proses;?>",
        ...
        if("<?=$proses;?>" == "live"){
            url = '<?php echo site_url('transaksi/gatein_lcl/sinkron_to_gateinlcl') ?>';
            data = {
