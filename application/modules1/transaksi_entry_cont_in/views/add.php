                                        ...
                                        <div class="col-xl-6 col-lglg-6 col-md-6 col-sm-12 col-12">
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="bon_bongkar_number" name="bon_bongkar_number"  value="<?= $bon_bongkar_number; ?>"readonly>
                                                        <input type="hidden" class="form-control form-control-sm" id="eir_r_number" name="eir_r_number"  value="<?= $eir_r_number; ?>"readonly>
                                                        <input type="hidden" class="form-control form-control-sm" id="id_cont_in" name="id_cont_in"  value="<?= $id_cont_in; ?>"readonly>
                                                    </div>
                                                </div>
                                            </div>     
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control form-control-sm hrufbesar" id="cont_number" name="cont_number" >
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm datepicker-dropdowns" id="cont_date_in" name="cont_date_in" value="<?php echo date('d-m-Y') ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="time" class="form-control form-control-sm" id="cont_time_in" name="cont_time_in" value="<?php echo date('H:i') ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="no_eir" name="no_eir" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm datepicker-dropdowns" id="tgl_eir" name="tgl_eir" >
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-6 col-lglg-6 col-md-6 col-sm-12 col-12">
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input type="text" class="form-control form-control-sm" id="loc_block" name="loc_block" placeholder="Block" value=".">
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <input type="text" class="form-control form-control-sm" id="loc_row" name="loc_row" placeholder="Row" value="..">
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <input type="text" class="form-control form-control-sm" id="loc_col" name="loc_col" placeholder="Col" value="..">
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <input type="text" class="form-control form-control-sm" id="loc_stack" name="loc_stack" placeholder="Stack" value="..">
                                                    </div>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input onkeypress="KeyPressEnter(event,this.id)" type="text" class="form-control form-control-sm hrufbesar" id="ship_line_code" name="ship_line_code" value=".">
                                                    </div>
                                                    <div class="col-sm-6">
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="invoice_in" name="invoice_in" value="." >
                                                    </div>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="plate" name="plate" value="." >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="clean_type" name="clean_type" value="." >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm datepicker-dropdowns" id="clean_date" name="clean_date" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input onkeypress="KeyPressEnter(event,this.id)" type="text" class="form-control form-control-sm hrufbesar" id="bc_code" name="bc_code" >
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control form-control-sm" id="bc_name" name="bc_name" readonly>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">    
    ...
    $('#btnsave').click(function() {
        ...
        url = '<?php echo site_url('transaksi/entry_cont_in/save') ?>';
        ...
        selectbaris = 0 ;        
        tbl_entry_cont_in.page('first').draw(false);
