...
<div class="page-header">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">..::: Invoice Out / Bahandle LCL :::..</li>
    </ol>
</div>
                ...
                <div class="card-body boxshadow">
                    ...
                    <div class="row gutters border" style="padding-top:0.6%;margin-bottom: -0%;">
                        ...
                        <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                <div class="form-group row gutters">
                                    <label for="inputName" class="col-sm-4 col-form-label text-left">Forwarder/PBM</label>
                                    <div class="col-sm-8">
                                        <?=$shipper_name;?>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $('#btnexport').click(function() {
        ...
        var page = "<?php echo base_url(); ?>report/invoice_lcl_out/export?data="+btoa(data) ;
        window.open(page);
