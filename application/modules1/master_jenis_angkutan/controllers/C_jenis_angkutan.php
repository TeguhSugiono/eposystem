...
class C_jenis_angkutan extends CI_Controller {
    ...
    function c_tbl_jenis_angkutan() {
        $database = "db_tpsonline";

        $select = 'id,jenis_angkutan';
        $form = 'tbl_m_tps_angkutan';
        $join = array();
    ...
    function c_save(){
        ...
        $hasil = $this->m_model->savedata($database, 'tbl_m_tps_angkutan', $data);
    ...
    function c_formedit(){
        ...
        $array_data = $this->m_model->table_tostring($database, '', 'tbl_m_tps_angkutan', '', array('id' => $id), '');
        $data = array(
    ...
    function c_update(){
        ...
        $hasil = $this->m_model->updatedata($database, 'tbl_m_tps_angkutan', $data, $where);
