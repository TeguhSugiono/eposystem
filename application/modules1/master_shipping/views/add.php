                            ...
                            <div class="card m-0">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row gutters">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="ship_line_code" name="ship_line_code" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row gutters">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="ship_line_name" name="ship_line_name" >
                                        </div>
                                    </div>
...
<script type="text/javascript">    
    $('#btnsave').click(function() {
        url = '<?php echo site_url('master/shipping/save') ?>';
        ...
        alert(dataok.pesan);
        selectbaris = 0 ;        
        tbl_shipping.page('first').draw(false);
