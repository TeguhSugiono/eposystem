    ...
    <div class="modal-dialog modal-xl boxshadow">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Input Delivery ( <?=$kode_trans;?> => <?=$operator;?> ) </h5>
                                        ...
                                        <div class="col-xl-4 col-lglg-4 col-md-4 col-sm-12 col-12">
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                                                <div class="form-group row gutters margin-input1">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="txtTimeOut" name="txtTimeOut" >
                                                    </div>
                                                </div>
                                            </div>
