                    ...
                    <div class="row gutters" style="margin-top: 1%;">                        
                        <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                            <div class="table-container" style="width:100%;"> 
                                ...
                                <div class="table-responsive" style="margin-top: -1%;">
                                    <table id="tbl_respon_sppb" class="table m-0 dataTable no-footer nowrap" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>ID</th>
                        ...
                        <div class="col-xl-6 col-lglg-6 col-md-6 col-sm-12 col-12">
                            <div class="table-container" style="width:100%;"> 
                                ...
                                <div class="table-responsive" style="margin-top: -3%;">
                                    <table id="tbl_respon_sppb_container" class="table m-0 dataTable no-footer nowrap" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>ID</th>
                        ...
                        <div class="col-xl-6 col-lglg-6 col-md-6 col-sm-12 col-12">
                            <div class="table-container" style="width:100%;"> 
                                ...
                                <div class="table-responsive" style="margin-top: -3%;">
                                    <table id="tbl_respon_sppb_kms" class="table m-0 dataTable no-footer nowrap" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>ID</th>
...
<script type="text/javascript">
    ...
    var tbl_respon_sppb ;
    var tbl_respon_sppb_container ;
    var tbl_respon_sppb_kms ;
    var param_alert = "" ;
    var ID = "" ;
    ...
    $('#submit').submit(function(e){
        ...
        if(param_alert == "perkdgudang"){
            ...
            if($('#Tgl_Sppb').val() == ""){
                alert('Tgl_Sppb Harus Diisi..');
                $('#Tgl_Sppb').focus();
                return;
            }

            if($('#No_Sppb').val() == ""){
                alert('No_Sppb Harus Diisi..');
                $('#No_Sppb').focus();
                return;
            }
        ...
        url = '<?php echo site_url('download/sppb_pib/download') ?>';
    ...
    function get_sppb(){
        url = '<?php echo site_url('download/sppb_pib/load_data') ?>';
        data = {ID:ID} ; 
        pesan = 'JavaScript load_data Error...';
        dataok = multi_ajax_proses(url, data, pesan);

        //console.log(dataok.data_sppb_cont) ;

        tbl_data_containerM('tbl_respon_sppb',dataok.data_sppb,dataok.jml_data_sppb);

        tbl_data_container('tbl_respon_sppb_container',dataok.data_sppb_cont,dataok.jml_data_sppb_cont);
        tbl_data_container('tbl_respon_sppb_kms',dataok.data_sppb_kms,dataok.jml_data_sppb_kms);
    }
    ...
    function create_datatableM(){
        tbl_respon_sppb = $('#tbl_respon_sppb').DataTable({
            "order": [],
            "searching": true,
            "ordering": true,
            "scrollX": true,
    ...
    $('#tbl_respon_sppb').on('click', 'tr', function () {
       var data = tbl_respon_sppb.row(this).data();
       if ($(this).hasClass('selected')) {
            ID = '';
            $(this).removeClass('selected');
        } else {
            ID = data[1];
            tbl_respon_sppb.$('tr.selected').removeClass('selected');
