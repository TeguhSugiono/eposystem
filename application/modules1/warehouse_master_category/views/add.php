            ...
            <div class="modal-body">
                <form id="formadd" class="form-horizontal" method="post" action="#">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="category_kode" name="category_kode">
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">    
    $('#btnsave').click(function() {
        url = '<?php echo site_url('warehouse_master/category/save') ?>';
        ...
        alert(dataok.pesan);
        selectbaris = 0 ;        
        tbl_category.page('first').draw(false);
