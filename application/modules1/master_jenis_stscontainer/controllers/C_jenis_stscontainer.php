...
class C_jenis_stscontainer extends CI_Controller {
    ...
    function c_tbl_jenis_stscontainer() {
        $database = "db_tpsonline";

        $select = 'id,keterangan';
        $form = 'tbl_m_tps_sts_container';
        $join = array();
    ...
    function c_save(){
        ...
        $id = $this->m_model->select_max_where($database, 'tbl_m_tps_sts_container', 'id');
        $data = array(
            'id' => $id,
        ...
        $hasil = $this->m_model->savedata($database, 'tbl_m_tps_sts_container', $data);
    ...
    function c_formedit(){
        ...
        $array_data = $this->m_model->table_tostring($database, '', 'tbl_m_tps_sts_container', '', array('id' => $id), '');
        $data = array(
    ...
    function c_update(){
        ...
        $hasil = $this->m_model->updatedata($database, 'tbl_m_tps_sts_container', $data, $where);
