    ...
    <div class="modal-dialog boxshadow" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="customModalTwoLabel">Add Jenis Status Container</h5>
...
<script type="text/javascript">    
    $('#btnsave').click(function() {
        url = '<?php echo site_url('master/jenis_stscontainer/save') ?>';
        ...
        alert(dataok.pesan);
        selectbaris = 0 ;        
        tbl_jenis_stscontainer.page('first').draw(false);
