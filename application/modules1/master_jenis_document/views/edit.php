    ...
    <div class="modal-dialog boxshadow" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="customModalTwoLabel">Edit Jenis Document</h5>
            ...
            <div class="modal-body">
                <form id="formedit" class="form-horizontal" method="post" action="#">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="id" name="id" value="<?=$array_data['id'];?>">
                        <input type="hidden" class="form-control" id="idold" name="idold" value="<?=$array_data['id'];?>">
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Jenis Document:</label>
                        <input type="text" class="form-control" id="jenis_document" name="jenis_document" value="<?=$array_data['jenis_document'];?>">
                    </div>
                </form>
            </div>
...
<script type="text/javascript">    
    $('#btnsave').click(function() {
        url = '<?php echo site_url('master/jenis_document/update') ?>';
