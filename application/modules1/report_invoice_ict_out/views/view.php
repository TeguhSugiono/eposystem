...
<div class="page-header">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Invoice ICT / ..::: Out & Bahandle :::..</li>
    </ol>
</div>
...
<script type="text/javascript">
    ...
    function prosesdata(){
        ...
        $.ajax({
            url: "<?php echo site_url('report/invoice_ict_out/proses') ?>",
            type: "POST",
            data: {
    ...
    $('#btnexport').click(function() {
        ...
        var page = "<?php echo base_url(); ?>report/invoice_ict_out/export?data="+btoa(data) ;
        window.open(page);
