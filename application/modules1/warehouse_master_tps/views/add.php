            ...
            <div class="modal-body">
                <form id="formadd" class="form-horizontal" method="post" action="#">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tps_name" name="tps_name">
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Address1:</label>
                        <input type="text" class="form-control" id="tps_address1" name="tps_address1">
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Address2:</label>
                        <input type="text" class="form-control" id="tps_address2" name="tps_address2">
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Address3:</label>
                        <input type="text" class="form-control" id="tps_address3" name="tps_address3">
                    </div>
                </form>
            </div>
...
<script type="text/javascript">    
    $('#btnsave').click(function() {
        url = '<?php echo site_url('warehouse_master/tps/save') ?>';
