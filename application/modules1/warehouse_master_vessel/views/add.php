            ...
            <div class="modal-body">
                <form id="formadd" class="form-horizontal" method="post" action="#">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="vessel_voyage" name="vessel_voyage">
                    </div>
                </form>
            </div>
...
<script type="text/javascript">    
    $('#btnsave').click(function() {
        url = '<?php echo site_url('warehouse_master/vessel/save') ?>';
        ...
        alert(dataok.pesan);
        selectbaris = 0 ;        
        tbl_vessel.page('first').draw(false);
