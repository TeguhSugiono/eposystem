    ...
    <div class="modal-dialog modal-xl boxshadow">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Input Receiving ( <?=$kode_trans;?> => <?=$operator;?> ) </h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row gutters">
                                        ...
                                        <div class="col-xl-4 col-lglg-4 col-md-4 col-sm-12 col-12">
                                            ...
                                            <!-- <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                                                <div class="form-group row gutters margin-input1">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="txtNoMobil" name="txtNoMobil" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                                                <div class="form-group row gutters margin-input1">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm datepicker-dropdowns" id="dtpOut" name="dtpOut" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                                                <div class="form-group row gutters margin-input1">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="time" class="form-control form-control-sm" id="txtTimeOut" name="txtTimeOut" >
                                                    </div>
                                                </div>
                                            </div> -->
                                        ...
                                        <div class="col-xl-4 col-lglg-4 col-md-4 col-sm-12 col-12">
                                            ...
                                            <!-- <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                                                <div class="form-group row gutters margin-input1">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="txtSealNo" name="txtSealNo" >
                                                    </div>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                                                <div class="form-group row gutters margin-input1">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="txtDestination" name="txtDestination" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                                                <div class="form-group row gutters margin-input1">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="txtRemarks" name="txtRemarks" >
                                                    </div>
                                                </div>
                                            </div>   -->                                          
                                            ...
                                            <!-- <div class="row gutters">
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="bl_no_input"  name="bl_no_input" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Consignee</label>
                                                        <input type="text" class="form-control" id="consignee_name_input" name="consignee_name_input" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Ex BL</label>
                                                        <input type="text" class="form-control" id="ex_blno_input" name="ex_blno_input" readonly>
                                                    </div>
                                                </div> 
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Category</label>
                                                        <input type="text" class="form-control" id="category_name_input" name="category_name_input" readonly>
                                                    </div>
                                                </div> 
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Desc Item</label>
                                                        <input type="text" class="form-control" id="item_desc_input" name="item_desc_input" readonly>
                                                    </div>
                                                </div> 
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Code Item</label>
                                                        <input type="text" class="form-control" id="item_code_input" name="item_code_input" readonly>
                                                    </div>
                                                </div>
                                            </div> -->
                                        </div>
                                            ...
                                            <!-- <div class="row gutters">
                                                ...
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="good_unit_input"  name="good_unit_input">
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Good GW</label>
                                                        <input readonly type="text" class="form-control" id="good_gross_weight_input"  name="good_gross_weight_input">
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Good Volume</label>
                                                        <input readonly type="text" class="form-control" id="good_volume_input"  name="good_volume_input">
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Damage</label>
                                                        <input readonly type="text" class="form-control" id="damage_unit_input"  name="damage_unit_input">
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Damage GW</label>
                                                        <input readonly type="text" class="form-control" id="damage_gross_weight_input" name="damage_gross_weight_input">
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Damage Volume</label>
                                                        <input readonly type="text" class="form-control" id="damage_volume_input"  name="damage_volume_input">
                                                    </div>
                                                </div>
                                            ...
                                            <!-- <div class="row gutters">                                                
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="location_name_input"  name="location_name_input" readonly>
                                                    </div>
                                                </div>
                                        ...
                                        <!-- <input type="hidden" class="form-control" id="t_stock_id"  name="t_stock_id"> -->
