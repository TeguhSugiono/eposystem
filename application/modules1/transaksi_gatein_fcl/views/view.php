...
<div class="page-header">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">..::: Gate In FCL :::..</li>
    </ol>
</div>
                        ...
                        <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                            <div class="table-container" style="width:100%"> 
                                ...
                                <div class="table-responsive" style="margin-top:-2%;padding: 1px 1px 70px 1px;">
                                    ...
                                    <table id="tbl_gatein_fcl" class="table m-0 dataTable no-footer nowrap" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>No</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        tbl_gatein_fcl = $('#tbl_gatein_fcl').DataTable({
            "destroy"       : true,
            "processing"    : true, 
            "serverSide"    : true, 
            "order"         : [], 
            ...
            "pageLength": 25,
            "ajax": {
                "url": "<?php echo site_url('transaksi/gatein_fcl/tbl_gatein_fcl') ?>",
                "type": "POST",
                "beforeSend": function() {
                ...
                "complete": function() {
                        ...
                        //tbl_gatein_fcl.$('tr.selected').removeClass('selected');
                        //tbl_gatein_fcl.row(selectbaris).nodes().to$().toggleClass( 'selected' );
                        
                        //var data = tbl_gatein_fcl.row(selectbaris).data();
                        //id_beacukai = data[1];
                        REF_NUMBER = '' ;
                        sending = '' ;
                    }
        ...
        $('#tbl_gatein_fcl tbody').on('click', 'tr', function() {
            var data = tbl_gatein_fcl.row(this).data();
    ...
    function GetCheckRefNumber(){
        $("#tbl_gatein_fcl input[type=checkbox]:checked").each(function () {
    ...
    $(document).on('click', '.btnsend', function(e) {
        ...
        url = '<?php echo site_url('transaksi/gatein_fcl/formkirimdata') ?>';
    ...
    $(document).on('click', '.btnedit', function(e) {
        ...
        url = '<?php echo site_url('transaksi/gatein_fcl/formedit') ?>';
    ...
    $(document).on('click', '.btnrebuild', function(e) {
        ...
        if (jawab === true) { 
            url = '<?php echo site_url('transaksi/gatein_fcl/change_reff_number') ?>';
            data = {REF_NUMBER: REF_NUMBER};
    ...
    $(document).on('click', '.btndelete', function(e) {
        ...
        if (jawab === true) { 
            url = '<?php echo site_url('transaksi/gatein_fcl/delete_reff_number') ?>';
    ...
    $(document).on('click', '.btnexport', function(e) {
        ...
        var page = "<?php echo base_url(); ?>transaksi/gatein_fcl/exportxls?data="+btoa(data) ;
        window.open(page);
