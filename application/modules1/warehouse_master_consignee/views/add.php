            ...
            <div class="modal-body">
                <form id="formadd" class="form-horizontal" method="post" action="#">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="consignee_address1" name="consignee_address1">
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Address2:</label>
                        <input type="text" class="form-control" id="consignee_address2" name="consignee_address2">
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Address3:</label>
                        <input type="text" class="form-control" id="consignee_address3" name="consignee_address3">
                    </div>
                </form>
            </div>
...
<script type="text/javascript">    
    $('#btnsave').click(function() {
        url = '<?php echo site_url('warehouse_master/consignee/save') ?>';
        ...
        alert(dataok.pesan);
        selectbaris = 0 ;        
        tbl_consignee.page('first').draw(false);
