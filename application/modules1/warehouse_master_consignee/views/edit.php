            ...
            <div class="modal-body">
                <form id="formedit" class="form-horizontal" method="post" action="#">
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Consignee Name:</label>
                        <input type="text" class="form-control" id="consignee_name" name="consignee_name" value="<?=$array_data['consignee_name'];?>">
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Address1:</label>
                        <input type="text" class="form-control" id="consignee_address1" name="consignee_address1" value="<?=$array_data['consignee_address1'];?>">
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Address2:</label>
                        <input type="text" class="form-control" id="consignee_address2" name="consignee_address2" value="<?=$array_data['consignee_address2'];?>">
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Address3:</label>
                        <input type="text" class="form-control" id="consignee_address3" name="consignee_address3" value="<?=$array_data['consignee_address3'];?>">
                        <input type="hidden" class="form-control" id="consignee_id" name="consignee_id" value="<?=$array_data['consignee_id'];?>">
                    </div>
                </form>
            </div>
...
<script type="text/javascript">    
    $('#btnsave').click(function() {
        url = '<?php echo site_url('warehouse_master/consignee/update') ?>';
