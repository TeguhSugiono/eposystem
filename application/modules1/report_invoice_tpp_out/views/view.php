...
<div class="page-header">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Invoice TPP / ..::: Out , Lelang & Bahandle :::..</li>
    </ol>
</div>
...
<script type="text/javascript">
    ...
    function prosesdata(){
        ...
        $.ajax({
            url: "<?php echo site_url('report/invoice_tpp_out/proses') ?>",
            type: "POST",
            data: {
    ...
    $('#btnexport').click(function() {
        ...
        var page = "<?php echo base_url(); ?>report/invoice_tpp_out/export?data="+btoa(data) ;
        window.open(page);
