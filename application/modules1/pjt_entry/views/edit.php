...
<div id="modal_edit_formcheckpjt" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                ...
                                <div class="row gutters">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tgljob"  name="tgljob" value="<?php echo showdate_dmy($array_data['tgljob']); ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label for="inputName">No. JOB</label>
                                            <input type="text" class="form-control" id="nojob" name="nojob" readonly value="<?php echo $array_data['nojob']; ?>" >
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label for="inputName">No. PIBK</label>
                                            <input type="text" class="form-control" id="pibk" name="pibk" value="<?php echo $array_data['pibk']; ?>" autofocus>
                                        </div>
                                    </div>
                                ...
                                <div class="row gutters">       
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control datepicker-dropdowns" id="tglpibk" name="tglpibk" value="<?php echo showdate_dmy($array_data['tglpibk']); ?>" type="text" >
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="nmimportir" name="nmimportir" value="<?php echo $array_data['nmimportir']; ?>">
                                ...
                                <div class="row gutters"> 
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nocontainer" name="nocontainer" value="<?php echo $array_data['nocontainer']; ?>"  class="form-control" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="asalbarang" name="asalbarang" value="<?php echo $array_data['asalbarang']; ?>" class="form-control" >
                                        </div>
                                    </div> 
...
<script type="text/javascript">
    ...
    $('#btnsave').click(function() {
        ...
        url = '<?php echo site_url('pjt/entry/update') ?>';
        ...
        alert(dataok.pesan);
        $('#modal_edit_formcheckpjt').modal('hide');
    });

    $('#modal_edit_formcheckpjt').on('hidden.bs.modal', function() {
