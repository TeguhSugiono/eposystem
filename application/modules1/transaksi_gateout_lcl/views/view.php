...
<script type="text/javascript">
    ...
    function GetCheckRefNumber(){
        ...
        $("#tbl_gateout_lcl input[type=checkbox]:checked").each(function () {
            ...
            array_temp.push(row.cells[2].innerHTML);
            array_temp.push(row.cells[5].innerHTML);
            array_temp.push(row.cells[6].innerHTML);
            array_temp.push(row.cells[7].innerHTML);
            array_temp.push(row.cells[10].innerHTML);
            array_temp.push(row.cells[20].innerHTML);

            //console.log(array_temp);

            arrREF_NUMBER.push(array_temp);
        });
    ...
    function HandleClick(Chk,param) {  
        ...
        var SplitArrayParam = param.split("###");
        var array_temp = [] ;

        array_temp.push(SplitArrayParam[0]);
        array_temp.push(SplitArrayParam[1]);
        array_temp.push(SplitArrayParam[2]);
        array_temp.push(SplitArrayParam[3]);
        array_temp.push(SplitArrayParam[4]);
        array_temp.push(SplitArrayParam[5]);
        ...
        if(Chek.checked == true){
            ...
            arrREF_NUMBER = removeArray(array_temp,arrREF_NUMBER);
    ...
    $(document).on('click', '.btnchangereffnumber', function(e) {
        ...
        // console.log(arrREF_NUMBER);
        // console.log(arrREF_NUMBER.length);
        // return;
    ...
    $(document).on('click', '.btnedit', function(e) {
        ...
        //console.log(REF_NUMBER_SELECTED) ;
        ...
        if(REF_NUMBER_SELECTED.length == 0){
            alert('Belum Ada Data Yang Dipilih..');
            return false;
        }

        url = '<?php echo site_url('transaksi/gateout_lcl/formedit') ?>';
        data = {REF_NUMBER_SELECTED:REF_NUMBER_SELECTED} ;
        divform = "#div_popup_form" ;
        idmodal = "#modal_edit" ;        
        createmodal(url,data,divform,idmodal); 
    ...
    $(document).on('click', '.btnrebuild', function(e) {
        ...
        var jawab = confirm('Anda yakin ingin mengganti REF_NUMBER yang baru ?');
    ...
    $(document).on('click', '.btnexport', function(e) {
        ...
        var page = "<?php echo base_url(); ?>transaksi/gateout_lcl/exportxls?data="+btoa(data) ;
        window.open(page);
