                                ...
                                <div class="card-body">
                                    <div class="row gutters">
                                        ...
                                        <div class="col-xl-6 col-lglg-6 col-md-6 col-sm-12 col-12">
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    <label for="inputName" class="col-sm-4 col-form-label text-left fontfcl">NO_MASTER_BL_AWB</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="NO_MASTER_BL_AWB" name="NO_MASTER_BL_AWB" 
                                                        value="<?=$array_search['NO_MASTER_BL_AWB'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-sm" id="NO_BL_AWB_NEW" name="NO_BL_AWB_NEW" 
                                                        value="<?=$array_search['NO_BL_AWB'];?>">
                                                        <input type="hidden" class="form-control form-control-sm" id="NO_BL_AWB" name="NO_BL_AWB" 
                                                        value="<?=$array_search['NO_BL_AWB'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <input type="hidden" class="form-control form-control-sm" id="NM_ANGKUT" name="NM_ANGKUT" 
                                                        value="<?=$array_search['NM_ANGKUT'];?>" readonly>
                                            <input type="hidden" class="form-control form-control-sm" id="NO_VOY_FLIGHT" name="NO_VOY_FLIGHT" 
                                                        value="<?=$array_search['NO_VOY_FLIGHT'];?>" readonly>
                                            <input type="hidden" class="form-control form-control-sm" id="CALL_SIGN" name="CALL_SIGN" 
                                                        value="<?=$array_search['CALL_SIGN'];?>" readonly>
