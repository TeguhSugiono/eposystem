    ...
    <div class="modal-dialog boxshadow" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="customModalTwoLabel">Add Jenis Expor/Import</h5>
            ...
            <div class="modal-body">
                <form id="formadd" class="form-horizontal" method="post" action="#">
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Jenis Export/Import:</label>
                        <input type="text" class="form-control" id="jenis_export_import" name="jenis_export_import">
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">    
    $('#btnsave').click(function() {
        url = '<?php echo site_url('master/jenis_export_import/save') ?>';
        ...
        alert(dataok.pesan);
        selectbaris = 0 ;        
        tbl_jenis_export_import.page('first').draw(false);
