...
<div class="page-header">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">..::: Data Reject :::..</li>
    </ol>
</div>
                    ...
                    <form id="submit" class="form-horizontal" method="post" action="#" enctype="multipart/form-data">
                        <div class="row gutters" style="padding-top:0.6%;margin-bottom: -0%;">                                            
                            ...
                            <div class="col-xl-6 col-lglg-6 col-md-6 col-sm-12 col-12">
                                <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                    <div class="form-group row gutters">
                                        <label for="inputName" class="col-sm-4 col-form-label text-left">Kode TPS</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control form-control-sm" id="Kd_Tps"  name="Kd_Tps" required>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-6 col-lglg-6 col-md-6 col-sm-6 col-12">
                            <div class="table-container" style="width:100%;"> 
                                ...
                                <div class="form-group row gutters" style="margin-top:2%;padding: 0 0 0 5px;">
                                    <label for="inputName" class="col-sm-12 col-form-label text-left"><div id="totalreject"></div></label>
                                </div>

                                <div class="table-responsive" style="margin-top: 1%;">
                                    <table id="tbl_reject_kirim" class="table m-0 dataTable no-footer nowrap" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>No Referensi</th>                                            
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#totalreject').html('Jumlah Data Reject Kirim : 0') ;
    });
    
    $('#submit').submit(function(e){
        e.preventDefault(); 

        alert('Fungsi Belum Dibuat... Karena Tidak punya contoh data yang di reject..!!');

        return;
        
        $('#totalreject').html('Jumlah Data Container : 0') ;

        url = '<?php echo site_url('cek/GetRejectData/download') ?>';
        ...
        if(dataok.msg != "Ya"){
            alert(dataok.pesan); 
            tbl_data_reject('tbl_reject_kirim','',0);        
            return;
        }

        alert(dataok.pesan);

        if(dataok.jml_data_reject_terkirim > 0){
            $('#totalreject').html('Jumlah Data reject Kirim : '+dataok.jml_data_reject_terkirim) ;
            tbl_data_reject('tbl_reject_kirim',dataok.data_reject_terkirim,dataok.jml_data_reject_terkirim);
        }else{
            tbl_data_reject('tbl_reject_kirim','',0);
        }
    ...
    function tbl_data_reject(IdDatatable,data,jml){
