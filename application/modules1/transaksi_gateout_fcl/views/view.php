                        ...
                        <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12">
                            <div class="table-container" style="width:100%"> 
                                ...
                                <div class="table-responsive" style="margin-top:-2%;padding: 1px 1px 70px 1px;">
                                    ...
                                    <table id="tbl_gateout_fcl" class="table m-0 dataTable no-footer nowrap" style="width: 100%;margin-bottom: 20%;">
                                        <thead>
                                            <tr>
                                                <th>No</th>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.btndelete', function(e) {
        ...
        if (jawab === true) { 
            url = '<?php echo site_url('transaksi/gateout_fcl/delete_reff_number') ?>';
    ...
    $(document).on('click', '.btnimport', function(e) {
        url = '<?php echo site_url('transaksi/gateout_fcl/import_gate_out') ?>';
        data = "" ;
        divform = "#div_popup_form" ;
    ...
    $(document).on('click', '.btnexport', function(e) {
        ...
        var page = "<?php echo base_url(); ?>transaksi/gateout_fcl/exportxls?data="+btoa(data) ;
        window.open(page);
