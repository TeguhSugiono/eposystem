                            ...
                            <div class="card m-0">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row gutters">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="code_principal" name="code_principal" value="<?=$array_data['code_principal'];?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row gutters">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="name_principal" name="name_principal" value="<?=$array_data['name_principal'];?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row gutters">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="hidden" class="form-control" id="id_principal" name="id_principal"  value="<?=$array_data['id_principal'];?>" >
                                        </div>
                                    </div>
...
<script type="text/javascript">    
    $('#btnsave').click(function() {
        url = '<?php echo site_url('master/principal/update') ?>';
