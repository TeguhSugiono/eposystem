        ...
        tblmstsupplier = $('#tblmstsupplier').DataTable({
            ...
            "columns": [{
                    ...
                    "render": function(data, type, row) {
                        ...
                        var namasupplier = escapeHtml(row.namasupplier);

                        return `
                            <a href="javascript:void(0)" onclick="editData('${row.kodesupplier}')" 
                                class="btn btn-sm btn-primary" title="Edit">
                                <i class="fa fa-edit"></i>
                            </a>
                            <button type="button" onclick="hapusData('${row.kodesupplier}', '${namasupplier}')" 
