...
<div class="modal-overlay active" id="id_modal_edit"> <!--style="margin-top: -18% !important;"-->
    <div class="modal medium">
        <div class="modal-header">
            <h3 class="modal-title"><i class="fa fa-edit"></i> Edit Satuan</h3>
        ...
        <div class="modal-body">
            ...
            <form id="formedit" class="form-horizontal" method="post" action="#">
                ...
                <div class="row mb-3">
                    <label class="col-sm-4 col-form-label text-end">Nama Satuan</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="namasatuan" name="namasatuan" value="<?= quotStr($GetDataEdit->namasatuan); ?>" required>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        url = '<?php echo site_url('mst_satuan/update_data') ?>';
        data = dataPost;
