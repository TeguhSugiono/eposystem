...
<div class="modal-overlay active" id="id_modal_add"> <!--style="margin-top: -18% !important;"-->
    <div class="modal medium">
        <div class="modal-header">
            <h3 class="modal-title"><i class="fa fa-plus"></i> Add Satuan</h3>
        ...
        <div class="modal-body">
            ...
            <form id="formadd" class="form-horizontal" method="post" action="#">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="namasatuan" name="namasatuan" required>
                    </div>
                </div>
            </form>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        url = '<?php echo site_url('mst_satuan/save_data') ?>';
        data = dataPost;
