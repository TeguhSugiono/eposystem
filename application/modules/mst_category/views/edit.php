...
<div class="modal-overlay active" id="id_modal_edit"> <!--style="margin-top: -18% !important;"-->
    <div class="modal medium">
        <div class="modal-header">
            <h3 class="modal-title"><i class="fa fa-edit"></i> Edit category</h3>
        ...
        <div class="modal-body">
            ...
            <form id="formedit" class="form-horizontal" method="post" action="#">
                <input type="hidden" class="form-control form-control-sm" id="no" name="no" value="<?= $GetDataEdit->no; ?>">
                ...
                <div class="row mb-3" style="text-align: center;margin-bottom:40px !important;font-weight: 700;">
                    <label class="col-sm-12 col-form-label text-end">
                        ID Data <<<>>>&nbsp;<?= $GetDataEdit->no; ?>&nbsp;<<<>>>
                    </label>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-4 col-form-label text-end">Nama category</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="namacategory" name="namacategory" value="<?= quotStr($GetDataEdit->nama); ?>" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="ex" name="ex" value="<?= quotStr($GetDataEdit->ex); ?>" required>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        url = '<?php echo site_url('mst_category/update_data') ?>';
        data = dataPost;
