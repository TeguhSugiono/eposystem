...
<div class="modal-overlay active" id="id_modal_add"> <!--style="margin-top: -18% !important;"-->
    <div class="modal medium">
        <div class="modal-header">
            <h3 class="modal-title"><i class="fa fa-plus"></i> Add category</h3>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        //var dataPost = $('#formadd').serialize() + '&categoryText=' + category + '&categoryText=' + category;
        var dataPost = $('#formadd').serialize();


        url = '<?php echo site_url('mst_category/save_data') ?>';
        data = dataPost;
