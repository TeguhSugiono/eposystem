...
<style>
    @media (max-width: 768px) {
        ...
        /* SEMBUNYIKAN HEADER ASLI DATATABLES */
        #tbltranshead thead,
...
<div class="card-container">
    ...
    <!-- CARD KIRI -->
    <div class="card card-left" data-width="55%">
        <div class="card-header">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tbltranshead = $('#tbltranshead').DataTable({
            "ajax": {
                ...
                "url": "<?php echo site_url('trans_purchaseorder/fetch_table'); ?>",
                "type": "POST",
                "data": function(d) {}
            ...
            "columns": [{
                    ...
                    "render": function(data, type, row) {
                        ...
                        class="btn btn-sm btn-primary" title="Edit" > <i class="fa fa-edit" ></i> </a> <button type="button" onclick="hapusData('${row.id_pesan}', '${nopo}')"
                        class="btn btn-sm btn-primary" title="Hapus" > <i class="fa fa-trash" ></i> </button> `;
                    }
                },
    ...
    function editData(id_pesan) {
        ...
        $.post('<?= site_url("trans_purchaseorder/edit_data") ?>/' + id_pesan, {}, function(html) {
            $('#divmodal').html(html);
