...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            /* optional: sembunyikan logo saat print */
        }
    </style>
</head>
...
<body>
    ...
    <?php
    // === DUMMY DATA ===
    // Ganti angka 35 ini untuk test (misal: 10 = 1 halaman, 20 = 2 halaman, dst)
    $total_dummy_items = 100;

    $per_page = 45;
    $pages = ceil($total_dummy_items / $per_page);

    $baris_halaman_terakhir = 0;
    if ($total_dummy_items < $per_page) {
        $baris_halaman_terakhir = $per_page - $total_dummy_items;
    } else {
        $baris_halaman_terakhir = $total_dummy_items % $per_page;
        $baris_halaman_terakhir = $baris_halaman_terakhir == 0 ? $per_page : $baris_halaman_terakhir;
    }


    //echo $baris_halaman_terakhir; // 10
                ...
                <tr>
                    <td width="45%">
                        <table border="0" width="100%" style="border:1px solid black;">
                            <tr>
                                <td>Kepada Yth.(Attention) <?= $baris_halaman_terakhir; ?></br>
    ...
    <div class="content no-break">
        ...
        <?php for ($page = 1; $page <= $pages; $page++): ?>
            ...
            <table border='1' style="border-collapse:collapse;border:1px solid black;margin-left:0.3% !important;" width="100%" class="font2">
                ...
                <!-- Kosongkan sisa baris biar layout tetap rapi (optional) -->
                <?php if ($page < $pages): ?>
        ...
        <!-- TOTAL, TERBILANG, PEMBAYARAN, DAN FOOTER HANYA DI HALAMAN TERAKHIR -->
